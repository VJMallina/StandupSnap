      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            ...
            className="px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >

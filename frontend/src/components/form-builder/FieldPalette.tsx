...
export const FieldPalette: React.FC<FieldPaletteProps> = ({ onAddField }) => {
  ...
  const categories = ['Basic', 'Selection', 'Advanced', 'Layout'];

  return (
    <div className="p-4">
      <h3 className="text-sm font-semibold text-gray-900 mb-4 uppercase tracking-wide">Field Types</h3>

      {categories.map((category) => {
        const categoryFields = fieldTypes.filter((f) => f.category === category);

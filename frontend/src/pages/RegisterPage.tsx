...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({ username, email, password, name, roleName });
      navigate('/');
    } catch (err) {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  name="role"
                  required
                  className="appearance-none block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 sm:text-sm bg-white"
                  value={roleName}

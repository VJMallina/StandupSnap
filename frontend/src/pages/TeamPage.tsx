              ...
              <div key={project.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    {project.productOwner && (
                      <div className="flex items-center text-sm">
                        ...
                        <span className="text-gray-900 font-medium">{project.productOwner.firstName} {project.productOwner.lastName}</span>
                      </div>
                    )}
                    {project.pmo && (
                      <div className="flex items-center text-sm">
                        <span className="text-gray-600 w-20">PMO:</span>
                        <span className="text-gray-900 font-medium">{project.pmo.firstName} {project.pmo.lastName}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-purple-600 text-white px-4 py-3 rounded-lg hover:bg-purple-700 font-semibold transition-colors flex items-center justify-center"
                  >
